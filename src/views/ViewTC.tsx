...
const ViewTC = () => {
    const header = <div className="d-flex align-items-center py-1"><IconWithBorder><FaHandshake /></IconWithBorder> Terms and Conditions</div>;
    return (
        <StyledBody className="h-100 overflow-hidden">
            <ScrollPanel header={header}>
                ...
                <ul>
                    ...
                    <li>
                        <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to POD Chat.</p>
                    </li>
                    <li>
                    ...
                    <li>
                        <p><strong>Website</strong> refers to POD Chat, accessible from <Link to="/">https://pod-chat.com</Link></p>
                    </li>
                    <li>
                ...
                <ul>
                    <li>By email: info at pod-chat.com</li>
                </ul>
            </ScrollPanel>
        </StyledBody>
    );
